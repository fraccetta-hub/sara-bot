...
// sarabot.pro reference in the workbook metadata (visible in file properties).
function brand(wb, title) {
  wb.creator = 'SaraBot';
  wb.lastModifiedBy = 'SaraBot';
  wb.company = 'sarabot.pro';
  wb.title = title;
  wb.subject = 'sarabot.pro';
  wb.keywords = 'sarabot.pro';
  wb.description = 'Generated by SaraBot — https://sarabot.pro';
  wb.created = new Date();
